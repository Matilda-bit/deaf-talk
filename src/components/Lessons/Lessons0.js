...
class Lessons0 extends Component {
  constructor(props) {
    super(props);
    this.state = {
      value: "",
  ...
  render() {
    return (
      <form onSubmit={this.handleSubmit}>
        ...
        <h4 />
        <h5 />
        {this.state.image1 ? <img src={cartImage1} alt={"image1"} /> : null}
        {this.state.image2 ? <img src={cartImage2} alt={"image2"} /> : null}
        {this.state.image3 ? <img src={cartImage3} alt={"image3"} /> : null}
        {this.state.image4 ? <img src={cartImage4} alt={"image4"} /> : null}
        {this.state.image5 ? <img src={cartImage5} alt={"image5"} /> : null}
        {this.state.image6 ? <img src={cartImage6} alt={"image6"} /> : null}
        {this.state.image7 ? <img src={cartImage7} alt={"image7"} /> : null}
        {this.state.image8 ? <img src={cartImage8} alt={"image8"} /> : null}
        {this.state.image9 ? <img src={cartImage9} alt={"image9"} /> : null}
        {this.state.image10 ? <img src={cartImage10} alt={"image10"} /> : null}
        {this.state.image11 ? <img src={cartImage11} alt={"image11"} /> : null}
        {this.state.image12 ? <img src={cartImage12} alt={"image12"} /> : null}
        {this.state.image13 ? <img src={cartImage13} alt={"image13"} /> : null}
        {this.state.image14 ? <img src={cartImage14} alt={"image14"} /> : null}
        {this.state.image15 ? <img src={cartImage15} alt={"image15"} /> : null}
        {this.state.image16 ? <img src={cartImage16} alt={"image16"} /> : null}
        {this.state.image17 ? <img src={cartImage17} alt={"image17"} /> : null}
        {this.state.image18 ? <img src={cartImage18} alt={"image18"} /> : null}
        {this.state.image19 ? <img src={cartImage19} alt={"image19"} /> : null}
        {this.state.image20 ? <img src={cartImage20} alt={"image20"} /> : null}
        {this.state.image21 ? <img src={cartImage21} alt={"image21"} /> : null}
        {this.state.image22 ? <img src={cartImage22} alt={"image22"} /> : null}
        {this.state.image23 ? <img src={cartImage23} alt={"image23"} /> : null}
        {this.state.image24 ? <img src={cartImage24} alt={"image24"} /> : null}
        {this.state.image25 ? <img src={cartImage25} alt={"image25"} /> : null}
        {this.state.image26 ? <img src={cartImage26} alt={"image26"} /> : null}
        {this.state.image27 ? <img src={cartImage27} alt={"image27"} /> : null}
      </form>
    );
  }
}
